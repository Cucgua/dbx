export default {
  ...
  ai: {
    ...
    manualSchema: "Schema",
    manualTable: "Nome da tabela",
    manualColumns: "Nomes das colunas, separados por vírgulas",
    backToCandidates: "Voltar aos candidatos",
    manualChoice: "Entrada manual",
    skipChoice: "Pular",
    confirmChoice: "Confirmar",
    joinType: "Tipo de JOIN",
    addRelationColumnPair: "Adicionar par de colunas",
    skipRelationConfirm: "Pular confirmação",
    confirmRelation: "Confirmar relação",
