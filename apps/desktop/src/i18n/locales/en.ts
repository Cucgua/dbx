export default {
  ...
  ai: {
    ...
    modeHints: {
      ...
      rag: "Use the active schema's RAG index for tables, columns, and business mappings",
    ...
    includeWorkspaceContextHint: "When disabled, the current SQL, last error, and result preview are not sent to AI.",
    tableChoiceTitle: "Confirm table",
    columnChoiceTitle: "Confirm columns",
    relationConfirmTitle: "Confirm relationship",
    manualSchema: "Schema",
    manualTable: "Table name",
    manualColumns: "Column names, separated by commas",
    backToCandidates: "Back to candidates",
    manualChoice: "Manual input",
    skipChoice: "Skip",
    confirmChoice: "Confirm",
    joinType: "JOIN type",
    addRelationColumnPair: "Add column pair",
    skipRelationConfirm: "Skip confirmation",
    ...
    schemaResearchUseMainModel: "Reuse main assistant model",
    schemaResearchUseMainModelHint: "Use the chat model above for SQL assistant subtasks",
