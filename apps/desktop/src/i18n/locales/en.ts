export default {
  ...
  ai: {
    ...
    enableThinkingHint:
      "This option only takes effect on supported models. /chat/completions forwards enable_thinking; /responses requests a reasoning summary. When disabled, it can significantly reduce token usage, but the quality of generated results may decrease slightly.",
    toolCall: "Tool",
    toolRunning: "Running",
    toolSucceeded: "Done",
    toolFailed: "Failed",
    ...
    thoughtNodeError: "Failed",
    thoughtNodeWaiting: "Waiting for user",
    thoughtNodeAbort: "Stopped",
    thoughtToolArguments: "Arguments",
    thoughtToolSummary: "Result",
    thoughtCollapse: "Collapse",
    thoughtExpand: "Expand",
    thoughtEarlierHidden: "Earlier content hidden; showing recent thoughts only",
    thoughtShowAll: "Show all",
    thoughtShowRecent: "Show recent",
    tableChoiceTitle: "AI needs a table",
    columnChoiceTitle: "AI needs columns",
    manualChoice: "None of these, enter manually",
    backToCandidates: "Back to candidates",
    manualSchema: "Schema",
    manualTable: "Table name",
    manualColumns: "Column names, comma-separated",
    skipChoice: "Skip",
    confirmChoice: "Confirm choice",
    includeWorkspaceContext: "Use current context",
    includeWorkspaceContextHint:
      "Include current SQL, last execution error, and result preview. Turn off to use only chat, schema, and tool retrieval.",
    relationConfirmTitle: "AI needs a table relationship",
    joinType: "JOIN type",
    addRelationColumnPair: "Add column pair",
    skipRelationConfirm: "Skip",
    confirmRelation: "Confirm relation",
    schemaResearchTitle: "Schema Research Model",
    schemaResearchHint:
      "Digests schema tool results and returns compact evidence. Reuse the chat model or configure a cheaper model to reduce context cost.",
    schemaResearchEnabled: "Enabled",
    schemaResearchEnabledOn: "Enabled",
    schemaResearchEnabledOff: "Disabled",
    schemaResearchUseMainModel: "Reuse chat model",
    schemaResearchUseMainModelHint: "Use the chat model above for Schema Research subtasks",
    schemaResearchProxyEnable: "Send Schema Research requests through proxy",
    schemaResearchMaxToolRounds: "Max tool rounds",
    schemaResearchMaxOutputTokens: "Max output tokens",
    schemaResearchNotice:
      "Schema Research receives the user request, current SQL, schema metadata, and compact tool summaries. Table data is never sent. This model must support /chat/completions function calling.",
    schemaRagTitle: "Schema Smart Index",
    schemaRagHint:
      "Configure embedding/rerank services separately for Analyze Schema and built-in AI schema retrieval. Chat model settings are not reused.",
    schemaRagEmbeddingProvider: "Embedding Provider",
    schemaRagDimension: "Vector Dimension",
    schemaRagBatchSize: "Batch Size",
    schemaRagConcurrency: "Concurrency",
    schemaRagRerankProvider: "Rerank Provider",
    schemaRagRerankNone: "Off",
    schemaRagRerankEndpoint: "Rerank Endpoint",
    schemaRagRerankModel: "Rerank Model",
    schemaRagRerankApiKey: "Rerank API Key",
    schemaRagProxyEnable: "Send Schema RAG requests through proxy",
    schemaRagPrivacyNotice:
      "Analyze Schema sends table names, column names, types, comments, indexes, and foreign keys to your configured embedding service. Table data is never sent.",
    actions: {
  ...
  contextMenu: {
    ...
    schemaRagAnalyze: "Analyze Schema",
    schemaRagStatus: "View Schema Smart Index Status",
    schemaRagTableStatus: "View Current Table Smart Index Status",
    ...
    schemaRagDeleteSuccess: "Schema smart index deleted",
    ...
    schemaRagApiDocsImportSuccess:
      "API docs imported: {sources} sources, {chunks} chunks, {facts} graph facts, {verified} verified, {unresolved} need confirmation, {unsupported} unsupported files",
    schemaRagApiDocProgressTitle: "API doc processing progress",
    schemaRagApiDocProgressStage: {
      idle: "Waiting",
      selecting: "Selecting docs",
      reading: "Reading files",
      splitting: "Splitting Markdown",
      extracting: "Extracting graph facts",
      importing: "Submitting import",
      refreshing: "Refreshing index status",
      finished: "Finished",
      failed: "Failed",
    },
    schemaRagApiDocProgressCurrentFile: "Current File",
    schemaRagApiDocProgressFiles: "Files",
    schemaRagApiDocProgressSections: "Current Sections",
    schemaRagApiDocProgressFailedFiles: "Failed Files",
    schemaRagApiDocProgressFieldFacts: "Field Facts",
    schemaRagApiDocProgressConceptFacts: "Concepts / Joins",
    schemaRagApiDocProgressLogs: "Recent Logs",
    schemaRagApiDocProgressSelecting: "Waiting for API docs selection",
    schemaRagApiDocProgressSelected: "Selected {count} files",
    schemaRagApiDocProgressReadable: "{count} Markdown files can be extracted into graph facts",
    schemaRagApiDocProgressReading: "Reading file: {file}",
    schemaRagApiDocProgressReadDone: "Read complete: {file}",
    ...
    schemaRagApiDocProgressImportDone:
      "Sidecar import complete: {chunks} chunks, {facts} facts, {verified} verified, {unresolved} need confirmation",
    schemaRagApiDocProgressRefreshing: "Refreshing Schema RAG status",
    schemaRagApiDocProgressFinished: "API doc processing finished",
    schemaRagApiDocProgressFailed: "API doc processing failed: {message}",
    ...
    schemaRagStatusTitle: "Schema Smart Index: {name}",
    schemaRagTableStatusTitle: "Table Smart Index: {name}",
    schemaRagAnalyzedAt: "Analyzed At",
    schemaRagModel: "Embedding Model",
    schemaRagTableName: "Table",
    schemaRagTableUpdatedAt: "Table Indexed At",
    schemaRagTableCount: "Tables",
    schemaRagColumnCount: "Columns",
    schemaRagIndexCount: "Indexes",
    schemaRagForeignKeyCount: "Foreign Keys",
    schemaRagDocumentCount: "Documents",
    schemaRagTableNotIndexed: "Current table is not in the analyzed schema index. Re-analyze the current schema first.",
    schemaRagApiDocSourceCount: "Doc Sources",
    schemaRagApiDocChunkCount: "Doc Chunks",
    schemaRagApiDocSources: "Imported API Docs",
    schemaRagApiDocSections: "{count} sections",
    schemaRagApiDocExtractionSummary:
      "{status}, fields {fields}, concepts {concepts}, joins {joins}, need confirmation {unresolved}",
  ...
  settings: {
    ...
    mcpTitle: "HTTP MCP Service",
    mcpDescription: "Configure the Streamable HTTP MCP service embedded in DBX Desktop.",
    mcpEnabled: "Enable MCP",
    mcpEnabledHint: "When disabled, DBX will not expose the HTTP MCP service on the next app start.",
    mcpHost: "Bind Host",
    mcpHostHint: "Use 127.0.0.1 for local access. Use 0.0.0.0 when WSL needs to reach DBX on Windows.",
    mcpPort: "Port",
    mcpPortHint: "1-65535. Default is 7424.",
    mcpEndpointPreview: "Endpoint after saving",
    mcpCopyEndpoint: "Copy MCP endpoint",
    mcpCurrentStatus: "Current Status",
    mcpStatusRunning: "Service is running",
    mcpStatusDisabled: "Service is disabled",
    mcpStatusUnknown: "No status information",
    mcpRefreshStatus: "Refresh status",
    mcpCurrentEndpoint: "Current Endpoint",
    mcpToken: "Access Token",
    mcpCopyToken: "Copy access token",
    mcpStartedAt: "Started at: {time}",
    mcpRestartHint:
      "MCP enabled state, bind host, and port take effect the next time DBX starts. Restart DBX and reconnect your MCP client after changing them.",
