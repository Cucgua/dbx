export default {
  ...
  ai: {
    ...
    enableThinkingHint:
      "此选项仅对部分支持的模型生效。/chat/completions 会透传 enable_thinking；/responses 会请求 reasoning summary。设为禁用后可大幅节省 token，但生成结果质量可能会略微下降。",
    toolCall: "工具调用",
    toolRunning: "调用中",
    toolSucceeded: "已完成",
    toolFailed: "失败",
    ...
    thoughtCollapse: "收起",
    thoughtExpand: "展开",
    thoughtEarlierHidden: "已隐藏较早内容，仅显示最近思考",
    thoughtShowAll: "展开全部",
    thoughtShowRecent: "只看最近",
    includeWorkspaceContext: "带当前上下文",
    includeWorkspaceContextHint: "携带当前 SQL、上次执行错误和结果预览；关闭后只使用聊天内容、Schema 和工具检索。",
    tableChoiceTitle: "AI 需要确认表",
    columnChoiceTitle: "AI 需要确认字段",
    manualChoice: "都不是，手动输入",
    backToCandidates: "返回候选",
    manualSchema: "Schema",
    manualTable: "表名",
    manualColumns: "字段名，多个用逗号分隔",
    skipChoice: "跳过",
    confirmChoice: "确认选择",
    relationConfirmTitle: "AI 需要确认表关联关系",
    joinType: "JOIN 类型",
    addRelationColumnPair: "添加字段对",
    skipRelationConfirm: "跳过",
    confirmRelation: "确认关系",
    schemaResearchTitle: "Schema Research 模型",
    schemaResearchHint: "用于消化 schema 工具结果并返回压缩证据。可复用主模型，也可配置便宜模型节省上下文成本。",
    schemaResearchEnabled: "启用",
    schemaResearchEnabledOn: "已启用",
    schemaResearchEnabledOff: "已禁用",
    schemaResearchUseMainModel: "复用主模型",
    schemaResearchUseMainModelHint: "使用上方聊天模型执行 Schema Research 子任务",
    schemaResearchProxyEnable: "Schema Research 请求通过代理发送",
    schemaResearchMaxToolRounds: "最大工具轮次",
    schemaResearchMaxOutputTokens: "最大输出 token",
    schemaResearchNotice:
      "Schema Research 模型只接收用户问题、当前 SQL、schema 元数据和工具结果摘要；不发送表数据。该模型必须支持 /chat/completions function calling。",
    schemaRagTitle: "Schema 智能索引",
    schemaRagHint: "为“分析 Schema”和内置 AI 的 schema 检索单独配置 embedding/rerank 服务，不复用聊天模型配置。",
    schemaRagEmbeddingProvider: "Embedding 提供商",
    schemaRagDimension: "向量维度",
    schemaRagBatchSize: "批大小",
    schemaRagConcurrency: "并发请求数",
    schemaRagRerankProvider: "Rerank 提供商",
    schemaRagRerankNone: "关闭",
    schemaRagRerankEndpoint: "Rerank Endpoint",
    schemaRagRerankModel: "Rerank 模型",
    schemaRagRerankApiKey: "Rerank API Key",
    schemaRagProxyEnable: "Schema RAG 请求通过代理发送",
    schemaRagPrivacyNotice:
      "分析 Schema 会把表名、字段名、类型、注释、索引、外键等元数据发送到你配置的 embedding 服务；不会发送表数据。",
    actions: {
      generate: "生成 SQL",
      explain: "解释 SQL",
      optimize: "优化 SQL",
  ...
  contextMenu: {
    ...
    schemaRagAnalyze: "分析 Schema",
    schemaRagStatus: "查看 Schema 智能索引状态",
    schemaRagTableStatus: "查看当前表智能索引状态",
    schemaRagRefreshTable: "刷新当前表智能索引",
    schemaRagImportApiDocs: "导入接口文档",
    schemaRagDelete: "删除 Schema 智能索引",
    schemaRagAnalyzeConfirm:
      "本功能会将当前 Schema 的表名、字段名、类型、注释、索引、外键等元数据发送到你配置的外部 embedding 服务。不会发送表数据。是否继续？",
    schemaRagAnalyzeSuccess: "Schema 智能索引已更新：{tables} 张表，{columns} 个字段",
    schemaRagRefreshTableConfirm:
      "本功能会重新读取当前表的字段、索引、外键等元数据，并发送到你配置的外部 embedding 服务。不会发送表数据。是否继续？",
    schemaRagRefreshTableSuccess: "当前表智能索引已刷新：重建 {documents} 条文档",
    schemaRagOperationFailed: "Schema 智能索引操作失败：{message}",
    schemaRagDeleteConfirm: "确定删除 Schema「{name}」的智能索引吗？",
    schemaRagDeleteSuccess: "Schema 智能索引已删除",
    ...
    schemaRagApiDocProgressTitle: "接口文档处理进度",
    schemaRagApiDocProgressStage: {
      idle: "等待开始",
      selecting: "选择文档",
      reading: "读取文件",
      splitting: "切分 Markdown",
      extracting: "抽取图谱事实",
      importing: "提交导入",
      refreshing: "刷新索引状态",
      finished: "处理完成",
    ...
    schemaRagApiDocProgressCurrentFile: "当前文件",
    schemaRagApiDocProgressFiles: "文件进度",
    schemaRagApiDocProgressSections: "当前片段",
    schemaRagApiDocProgressFailedFiles: "失败文件",
    schemaRagApiDocProgressFieldFacts: "字段事实",
    schemaRagApiDocProgressConceptFacts: "概念 / 关系",
    schemaRagApiDocProgressLogs: "最近日志",
    schemaRagApiDocProgressSelecting: "等待选择接口文档",
    schemaRagApiDocProgressSelected: "已选择 {count} 个文件",
    schemaRagApiDocProgressReadable: "其中 {count} 个 Markdown 文件可抽取图谱事实",
    schemaRagApiDocProgressReading: "读取文件：{file}",
    schemaRagApiDocProgressReadDone: "读取完成：{file}",
    schemaRagApiDocProgressSkipUnsupported: "跳过不支持抽取的文件：{file}",
    schemaRagApiDocProgressSplitDone: "切分完成：{file}，{sections} 个片段",
    schemaRagApiDocProgressExtracting: "调用子模型抽取：{file}",
    schemaRagApiDocProgressExtractDone: "抽取完成：{file}，字段 {fields}，概念 {concepts}，关系 {joins}",
    schemaRagApiDocProgressExtractFailed: "抽取失败：{file}，{message}",
    schemaRagApiDocProgressImporting: "提交 sidecar 校验、embedding 并写入图谱",
    schemaRagApiDocProgressImportDone:
      "sidecar 导入完成：{chunks} 个片段，{facts} 个事实，verified {verified}，待确认 {unresolved}",
    schemaRagApiDocProgressRefreshing: "刷新 Schema RAG 状态",
    schemaRagApiDocProgressFinished: "接口文档处理完成",
    schemaRagApiDocProgressFailed: "接口文档处理失败：{message}",
    ...
    schemaRagStatusTitle: "Schema 智能索引：{name}",
    schemaRagTableStatusTitle: "表智能索引：{name}",
    schemaRagAnalyzedAt: "分析时间",
    schemaRagModel: "Embedding 模型",
    schemaRagTableName: "表",
    schemaRagTableUpdatedAt: "表索引时间",
    schemaRagTableCount: "表",
    schemaRagColumnCount: "字段",
    schemaRagIndexCount: "索引",
    schemaRagForeignKeyCount: "外键",
    schemaRagDocumentCount: "文档",
    schemaRagTableNotIndexed: "当前表不在已分析的 Schema 索引中，请先重新分析当前 Schema。",
    schemaRagApiDocSourceCount: "文档源",
  ...
  settings: {
    ...
    mcpTitle: "HTTP MCP 服務",
    mcpDescription: "設定 DBX 桌面端內建的 Streamable HTTP MCP 服務。",
    mcpEnabled: "啟用 MCP",
    mcpEnabledHint: "關閉後，下次啟動 DBX 時不會暴露 HTTP MCP 服務。",
    mcpHost: "監聽位址",
    mcpHostHint: "本機存取使用 127.0.0.1；需要從 WSL 存取 Windows DBX 時可改為 0.0.0.0。",
    mcpPort: "連接埠",
    mcpPortHint: "1-65535，預設 7424。",
    mcpEndpointPreview: "儲存後位址",
    mcpCopyEndpoint: "複製 MCP 位址",
    mcpCurrentStatus: "目前執行狀態",
    mcpStatusRunning: "服務正在執行",
    mcpStatusDisabled: "服務已關閉",
    mcpStatusUnknown: "沒有狀態資訊",
    mcpRefreshStatus: "重新整理狀態",
    mcpCurrentEndpoint: "目前位址",
    mcpToken: "存取權杖",
    mcpCopyToken: "複製存取權杖",
    mcpStartedAt: "啟動時間：{time}",
    mcpRestartHint: "MCP 開關、監聽位址和連接埠會在下次啟動 DBX 時生效。修改後請重啟 DBX，並重新連接 MCP 用戶端。",
