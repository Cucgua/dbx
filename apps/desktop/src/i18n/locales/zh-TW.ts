export default {
  ...
  ai: {
    ...
    modeHints: {
      ...
      agent: "可自動執行安全查詢",
      rag: "使用目前 schema 的 RAG 索引檢索資料表、欄位和業務映射",
      ragChecking: "正在檢查目前 schema 是否有 RAG 索引",
      ragUnavailableNoSchema: "目前上下文沒有明確 schema，無法使用 RAG",
      ragUnavailableNoIndex: "目前 schema 沒有 RAG 分析內容，無法選擇 RAG",
      ragUnavailableUnsupportedAiConfig: "目前 AI 設定不支援 function call，請切換到 Chat Completions 相容模型",
    },
    fixWithAi: "用 AI 修復",
    truncated: "上下文已截斷",
    ...
    includeWorkspaceContext: "編輯器脈絡",
    includeWorkspaceContextOn: "已帶入",
    includeWorkspaceContextOff: "未帶入",
    includeWorkspaceContextHint: "關閉後不會把目前 SQL、上次錯誤和結果預覽傳送給 AI。",
    tableChoiceTitle: "確認資料表",
    columnChoiceTitle: "確認欄位",
    relationConfirmTitle: "確認資料表關係",
    manualSchema: "Schema",
    manualTable: "資料表名稱",
    manualColumns: "欄位名稱，多個以逗號分隔",
    backToCandidates: "返回候選",
    manualChoice: "手動輸入",
    skipChoice: "略過",
    confirmChoice: "確認",
    joinType: "JOIN 類型",
    addRelationColumnPair: "新增欄位對",
    skipRelationConfirm: "略過確認",
    confirmRelation: "確認關係",
    ...
    thoughtNodeError: "失敗",
    thoughtNodeWaiting: "等待使用者",
    thoughtNodeAbort: "已停止",
    thoughtToolArguments: "參數",
    thoughtToolSummary: "結果",
    thoughtCollapse: "收合",
    thoughtExpand: "展開",
    thoughtEarlierHidden: "已隱藏較早內容，僅顯示最近過程",
    thoughtShowAll: "顯示全部",
    ...
    schemaResearchUseMainModel: "複用主助手模型",
    schemaResearchUseMainModelHint: "使用上方聊天模型執行 SQL 助手子任務",
  ...
  contextMenu: {
    ...
    schemaRagStatus: "檢視 Schema 智能索引狀態",
    schemaRagTableStatus: "檢視目前表智能索引狀態",
    ...
    schemaRagDeleteSuccess: "Schema 智能索引已刪除",
    schemaRagNoIndex: "目前 Schema 尚未分析",
    schemaRagApiDocMarkdownFilter: "Markdown 介面文件",
    schemaRagApiDocFutureFilter: "Word / PDF（目前不支援）",
    schemaRagApiDocsImportSuccess: "介面文件匯入完成：{sources} 個文件源，{chunks} 個片段，不支援 {unsupported} 個檔案",
    schemaRagApiDocProgressImporting: "提交 sidecar 校驗、embedding 並寫入圖譜",
    schemaRagApiDocProgressRefreshing: "重新整理 Schema RAG 狀態",
    ...
    schemaRagProgressFinished: "Schema 智能索引寫入完成",
    schemaRagStatusTitle: "Schema 智能索引：{name}",
    schemaRagTableStatusTitle: "表智能索引：{name}",
    schemaRagAnalyzedAt: "分析時間",
    schemaRagModel: "Embedding 模型",
    schemaRagTableName: "表",
    schemaRagTableUpdatedAt: "表索引時間",
    schemaRagTableCount: "表",
    schemaRagColumnCount: "欄位",
    schemaRagIndexCount: "索引",
    schemaRagForeignKeyCount: "外鍵",
    schemaRagDocumentCount: "文件",
    schemaRagTableNotIndexed: "目前表不在已分析的 Schema 索引中，請先重新分析目前 Schema。",
    schemaRagApiDocSourceCount: "文件源",
    schemaRagApiDocChunkCount: "文件片段",
    schemaRagApiDocSources: "已匯入介面文件",
