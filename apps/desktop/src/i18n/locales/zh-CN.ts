export default {
  ...
  ai: {
    ...
    modeHints: {
      ...
      agent: "可自动执行安全查询",
      rag: "使用当前 schema 的 RAG 索引检索表、字段和业务映射",
      ragChecking: "正在检查当前 schema 是否有 RAG 索引",
      ragUnavailableNoSchema: "当前上下文没有明确 schema，无法使用 RAG",
      ragUnavailableNoIndex: "当前 schema 没有 RAG 分析内容，无法选择 RAG",
      ragUnavailableUnsupportedAiConfig: "当前 AI 配置不支持 function call，请切换到 Chat Completions 兼容模型",
    },
    fixWithAi: "用 AI 修复",
    truncated: "上下文已截断",
    ...
    includeWorkspaceContext: "编辑器上下文",
    includeWorkspaceContextOn: "已带入",
    includeWorkspaceContextOff: "未带入",
    includeWorkspaceContextHint: "关闭后不会把当前 SQL、上次错误和结果预览发送给 AI。",
    tableChoiceTitle: "确认表",
    columnChoiceTitle: "确认字段",
    relationConfirmTitle: "确认表关系",
    manualSchema: "Schema",
    manualTable: "表名",
    ...
    toolSucceeded: "已完成",
    toolFailed: "失败",
    toolTraceCollapsedSummary: "已调用 {total} 个工具：成功 {success} 个，失败 {failed} 个，进行中 {running} 个",
    thoughtChain: "执行过程",
    thoughtNodeLoading: "运行中",
    ...
    thoughtCollapse: "收起",
    thoughtExpand: "展开",
    thoughtEarlierHidden: "已隐藏较早内容，仅显示最近过程",
    thoughtShowAll: "显示全部",
    thoughtShowRecent: "只看最近",
    schemaResearchTitle: "SQL 助手子 agent",
    schemaResearchHint: "用于在 RAG 对话中调用 schema 工具取证并压缩结果。可复用主助手模型，也可配置独立模型节省上下文成本。",
    schemaResearchEnabled: "启用",
    schemaResearchEnabledOn: "已启用",
    schemaResearchEnabledOff: "已禁用",
    schemaResearchUseMainModel: "复用主助手模型",
    schemaResearchUseMainModelHint: "使用上方聊天模型执行 SQL 助手子任务",
    schemaResearchProxyEnable: "SQL 助手请求通过代理发送",
    schemaResearchMaxToolRounds: "最大工具轮次",
    schemaResearchMaxOutputTokens: "最大输出 token",
    schemaResearchNotice: "SQL 助手会接收用户请求、当前 SQL、schema 元数据和压缩后的工具摘要，不会发送表数据。该模型必须支持 /chat/completions function call。",
    actions: {
      generate: "生成 SQL",
      explain: "解释 SQL",
      optimize: "优化 SQL",
  ...
  contextMenu: {
    ...
    schemaRagAnalyzeConfirm: "本功能会将当前 Schema 的表名、字段名、类型、注释、索引、外键等元数据发送到你配置的外部 embedding 服务。不会发送表数据。是否继续？",
    schemaRagAnalyzeSuccess: "Schema 智能索引已更新：{tables} 张表，{columns} 个字段",
    schemaRagRefreshTableConfirm: "本功能会重新读取当前表的字段、索引、外键等元数据，并发送到你配置的外部 embedding 服务。不会发送表数据。是否继续？",
    ...
    schemaRagApiDocFutureFilter: "Word / PDF（当前不支持）",
    ...
    schemaRagProgressEmbeddingRequest: "正在发送 embedding 第 {batch}/{batches} 批，已完成 {done}/{total}，本批 {size} 条，并发 {concurrency}，飞行中 {inFlight}",
