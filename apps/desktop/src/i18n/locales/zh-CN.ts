export default {
  ...
  settings: {
    ...
    mcpTitle: "HTTP MCP 服务",
    mcpDescription: "配置 DBX 桌面端内置的 Streamable HTTP MCP 服务。",
    mcpEnabled: "启用 MCP",
    mcpEnabledHint: "关闭后，下次启动 DBX 时不会暴露 HTTP MCP 服务。",
    mcpHost: "监听地址",
    mcpHostHint: "本机访问使用 127.0.0.1；需要从 WSL 访问 Windows DBX 时可改为 0.0.0.0。",
    mcpPort: "端口",
    mcpPortHint: "1-65535，默认 7424。",
    mcpEndpointPreview: "保存后地址",
    mcpCopyEndpoint: "复制 MCP 地址",
    mcpCurrentStatus: "当前运行状态",
    mcpStatusRunning: "服务正在运行",
    mcpStatusDisabled: "服务已关闭",
    mcpStatusUnknown: "没有状态信息",
    mcpRefreshStatus: "刷新状态",
    mcpCurrentEndpoint: "当前地址",
    mcpToken: "访问令牌",
    mcpCopyToken: "复制访问令牌",
    mcpStartedAt: "启动时间：{time}",
    mcpRestartHint: "MCP 开关、监听地址和端口会在下次启动 DBX 时生效。修改后请重启 DBX，并重新连接 MCP 客户端。",
