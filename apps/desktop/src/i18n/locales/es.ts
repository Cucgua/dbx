export default {
  ...
  ai: {
    ...
    enableThinkingHint:
      "Esta opción solo aplica a modelos compatibles. /chat/completions reenvía enable_thinking; /responses solicita un resumen de razonamiento. Al desactivarla se puede reducir el uso de tokens, pero la calidad puede bajar ligeramente.",
    toolCall: "Herramienta",
    toolRunning: "Ejecutando",
    toolSucceeded: "Completado",
    toolFailed: "Falló",
    thoughtChain: "Ejecución",
    thoughtNodeLoading: "Ejecutando",
    thoughtNodeSuccess: "Completado",
    thoughtNodeError: "Falló",
    thoughtNodeWaiting: "Esperando al usuario",
    thoughtNodeAbort: "Detenido",
    thoughtToolArguments: "Argumentos",
    thoughtToolSummary: "Resultado",
    thoughtCollapse: "Contraer",
    thoughtExpand: "Expandir",
    thoughtEarlierHidden: "Contenido anterior oculto; solo se muestran pensamientos recientes",
    thoughtShowAll: "Mostrar todo",
    thoughtShowRecent: "Mostrar recientes",
    tableChoiceTitle: "La IA necesita una tabla",
    columnChoiceTitle: "La IA necesita columnas",
    manualChoice: "Ninguna, introducir manualmente",
    backToCandidates: "Volver a candidatos",
    manualSchema: "Schema",
    manualTable: "Nombre de tabla",
    manualColumns: "Columnas, separadas por comas",
    skipChoice: "Omitir",
    confirmChoice: "Confirmar selección",
    includeWorkspaceContext: "Usar contexto actual",
    includeWorkspaceContextHint:
      "Incluye SQL actual, último error de ejecución y vista previa de resultados. Desactívalo para usar solo chat, schema y herramientas.",
    relationConfirmTitle: "La IA necesita una relación entre tablas",
    joinType: "Tipo JOIN",
    addRelationColumnPair: "Agregar par de columnas",
    skipRelationConfirm: "Omitir",
    confirmRelation: "Confirmar relación",
    ...
    schemaResearchUseMainModel: "Reutilizar modelo principal",
    schemaResearchUseMainModelHint: "Usar el modelo de chat superior para subtareas de Schema Research",
    ...
    schemaRagTitle: "Índice inteligente de Schema",
    schemaRagHint:
      "Configura servicios de embedding/rerank separados para Analizar Schema y la recuperación de schema de la IA integrada.",
    schemaRagEmbeddingProvider: "Proveedor de embedding",
    schemaRagDimension: "Dimensión vectorial",
    schemaRagBatchSize: "Tamaño de lote",
    schemaRagConcurrency: "Concurrencia",
    schemaRagRerankProvider: "Proveedor rerank",
    schemaRagRerankNone: "Desactivado",
    schemaRagRerankEndpoint: "Endpoint rerank",
    schemaRagRerankModel: "Modelo rerank",
    schemaRagRerankApiKey: "API Key rerank",
    schemaRagProxyEnable: "Enviar solicitudes de Schema RAG mediante proxy",
    schemaRagPrivacyNotice:
      "Analizar Schema envía nombres de tablas, columnas, tipos, comentarios, índices y claves externas al servicio de embedding configurado. No se envían datos de tablas.",
    actions: {
  ...
  contextMenu: {
    ...
    schemaRagAnalyze: "Analizar Schema",
    schemaRagStatus: "Ver estado del índice inteligente de Schema",
    schemaRagTableStatus: "Ver estado del índice inteligente de la tabla actual",
    schemaRagRefreshTable: "Actualizar índice inteligente de la tabla actual",
    schemaRagImportApiDocs: "Importar documentos API",
    schemaRagDelete: "Eliminar índice inteligente de Schema",
    schemaRagAnalyzeConfirm:
      "Esto enviará nombres de tablas, columnas, tipos, comentarios, índices y claves externas del Schema actual al servicio externo de embedding configurado. No se enviarán datos de tablas. ¿Continuar?",
    ...
    schemaRagNoIndex: "El Schema actual aún no ha sido analizado",
    ...
    schemaRagApiDocProgressTitle: "Progreso de documentos API",
    schemaRagApiDocProgressStage: {
      idle: "En espera",
      selecting: "Seleccionando documentos",
      reading: "Leyendo archivos",
      splitting: "Dividiendo Markdown",
      extracting: "Extrayendo hechos del grafo",
      importing: "Enviando importación",
      refreshing: "Actualizando estado del índice",
      finished: "Finalizado",
      failed: "Fallido",
    },
    schemaRagApiDocProgressCurrentFile: "Archivo actual",
    schemaRagApiDocProgressFiles: "Archivos",
    schemaRagApiDocProgressSections: "Secciones actuales",
    schemaRagApiDocProgressFailedFiles: "Archivos fallidos",
    schemaRagApiDocProgressFieldFacts: "Hechos de campos",
    schemaRagApiDocProgressConceptFacts: "Conceptos / relaciones",
    schemaRagApiDocProgressLogs: "Logs recientes",
    schemaRagApiDocProgressSelecting: "Esperando selección de documentos API",
    schemaRagApiDocProgressSelected: "{count} archivos seleccionados",
    schemaRagApiDocProgressReadable: "{count} archivos Markdown pueden extraerse como hechos del grafo",
    schemaRagApiDocProgressReading: "Leyendo archivo: {file}",
    schemaRagApiDocProgressReadDone: "Lectura completa: {file}",
    schemaRagApiDocProgressSkipUnsupported: "Omitiendo archivo no compatible para extracción: {file}",
    schemaRagApiDocProgressSplitDone: "División completa: {file}, {sections} secciones",
    schemaRagApiDocProgressExtracting: "Llamando submodelo de extracción: {file}",
    schemaRagApiDocProgressExtractDone:
      "Extracción completa: {file}, campos {fields}, conceptos {concepts}, relaciones {joins}",
    schemaRagApiDocProgressExtractFailed: "Extracción fallida: {file}, {message}",
    schemaRagApiDocProgressImporting: "Enviando al sidecar para validar, crear embeddings y escribir el grafo",
    schemaRagApiDocProgressImportDone:
      "Importación sidecar completa: {chunks} fragmentos, {facts} hechos, {verified} verificados, {unresolved} por confirmar",
    schemaRagApiDocProgressRefreshing: "Actualizando estado de Schema RAG",
    schemaRagApiDocProgressFinished: "Procesamiento de documentos API finalizado",
    schemaRagApiDocProgressFailed: "Procesamiento de documentos API fallido: {message}",
    ...
    schemaRagProgressEmbeddingQueued: "{total} documentos embedding en {batches} lotes con concurrencia {concurrency}",
    schemaRagProgressEmbeddingRequest:
      "Enviando lote embedding {batch}/{batches}; completado {done}/{total}; tamaño {size}; concurrencia {concurrency}; en curso {inFlight}",
    schemaRagProgressEmbeddingDone:
      "Lote embedding {batch}/{batches} devuelto; completado {done}/{total}; en curso {inFlight}",
    schemaRagProgressEmbeddingFailed: "Falló el lote embedding {batch}/{batches}",
    schemaRagProgressWrite: "Escribiendo archivos del índice inteligente",
    schemaRagProgressFinished: "Índice inteligente escrito",
    schemaRagStatusTitle: "Índice inteligente de Schema: {name}",
    schemaRagTableStatusTitle: "Índice inteligente de tabla: {name}",
    schemaRagAnalyzedAt: "Analizado",
    schemaRagModel: "Modelo embedding",
    schemaRagTableName: "Tabla",
    schemaRagTableUpdatedAt: "Tabla indexada",
    schemaRagTableCount: "Tablas",
    schemaRagColumnCount: "Columnas",
    schemaRagIndexCount: "Índices",
    schemaRagForeignKeyCount: "Claves externas",
    schemaRagDocumentCount: "Documentos",
    schemaRagTableNotIndexed: "La tabla actual no está en el índice del Schema. Analiza de nuevo el Schema actual.",
    schemaRagApiDocSourceCount: "Fuentes doc",
  ...
  settings: {
    ...
    mcpTitle: "Servicio HTTP MCP",
    mcpDescription: "Configura el servicio Streamable HTTP MCP integrado en DBX Desktop.",
    mcpEnabled: "Activar MCP",
    mcpEnabledHint: "Si se desactiva, DBX no expondrá el servicio HTTP MCP en el siguiente inicio.",
    mcpHost: "Dirección de escucha",
    mcpHostHint: "Usa 127.0.0.1 para acceso local. Usa 0.0.0.0 cuando WSL necesite acceder a DBX en Windows.",
    mcpPort: "Puerto",
    mcpPortHint: "1-65535. Valor predeterminado: 7424.",
    mcpEndpointPreview: "Endpoint después de guardar",
    mcpCopyEndpoint: "Copiar endpoint MCP",
    mcpCurrentStatus: "Estado actual",
    mcpStatusRunning: "El servicio está en ejecución",
    mcpStatusDisabled: "El servicio está desactivado",
    mcpStatusUnknown: "Sin información de estado",
    mcpRefreshStatus: "Actualizar estado",
    mcpCurrentEndpoint: "Endpoint actual",
    mcpToken: "Token de acceso",
    mcpCopyToken: "Copiar token de acceso",
    mcpStartedAt: "Iniciado a las: {time}",
    mcpRestartHint:
      "El estado de MCP, la dirección de escucha y el puerto se aplican la próxima vez que DBX se inicie. Reinicia DBX y vuelve a conectar el cliente MCP después de cambiarlos.",
