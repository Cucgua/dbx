export default {
  ...
  ai: {
    ...
    manualColumns: "Nombres de columnas, separados por comas",
    backToCandidates: "Volver a candidatos",
    manualChoice: "Entrada manual",
    skipChoice: "Omitir",
    confirmChoice: "Confirmar",
    joinType: "Tipo de JOIN",
    addRelationColumnPair: "Añadir par de columnas",
    skipRelationConfirm: "Omitir confirmación",
    ...
    thoughtNodeWaiting: "Esperando usuario",
    ...
    thoughtEarlierHidden: "Contenido anterior oculto; mostrando solo pensamientos recientes",
