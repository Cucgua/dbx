...
const LATEST_JSON_URLS: &[&str] = &[
    "https://update.hwdns.net/https://github.com/Cucgua/dbx/releases/latest/download/latest.json",
    "https://gh-proxy.org/https://github.com/Cucgua/dbx/releases/latest/download/latest.json",
    "https://github.com/Cucgua/dbx/releases/latest/download/latest.json",
];
const GITHUB_RELEASE_API_PREFIX: &str = "https://api.github.com/repos/Cucgua/dbx/releases/tags/v";
...
"#;
    ...
    fn parses_jdbc_plugin_metadata_from_latest_json() {
        let release: TauriRelease = serde_json::from_str(
            r#"{
              ...
              "jdbc_plugin": {
                "version": "0.1.3",
                "protocol_version": 1,
                "url": "https://github.com/Cucgua/dbx/releases/latest/download/dbx-jdbc-plugin-latest.zip"
              },
              "platforms": {}
            }"#,
        )
        ...
        assert_eq!(jdbc.url, "https://github.com/Cucgua/dbx/releases/latest/download/dbx-jdbc-plugin-latest.zip");
    }
    ...
    fn update_info_prefers_github_release_metadata() {
        let release = TauriRelease {
            ...
            github: Some(GithubReleaseMetadata {
                ...
                html_url: Some("https://github.com/Cucgua/dbx/releases/tag/v0.5.3".to_string()),
                body: Some("### 新功能\n\n真实发布说明".to_string()),
            }),
        };
        ...
        assert_eq!(info.release_url, "https://github.com/Cucgua/dbx/releases/tag/v0.5.3");
