...
|---|---|---|
| Core SQL engines | MySQL, PostgreSQL, SQLite, DuckDB, ClickHouse, SQL Server, Oracle, Oracle OCI (11g), Redshift, DM, GaussDB | Available directly in the DBX connection picker |
